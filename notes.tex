...
The {\bf shortest path algorithm} finds the shortest path from the {\bf start state} to a {\bf goal state} in terms of path elements which all have the same value.
