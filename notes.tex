...
{\bf Hidden Markov models} (HMMs) are used to analyze and predict time series. A {\bf Markov chain} is a temporal Bayes network which consists of states and transition probabilities. Figure \ref{ref:samplemarkovchain} represents a sample Markov chain.
