...
{\bf Hidden Markov models} (HMMs) are used to analyze and predict time series. They are related to Markov chains which are explained in Chapter~\ref{ref:markovchains}.
