...
{\bf Markiv localization} is a grid-based localization which uses histogram to represent the belief distribution. Localization starts in an initial {\bf belief state} and consists of two steps: {\bf prediction} and {\bf movement}. Prediction gains information on the current localization. In contrast, movement loses information as movements are inaccurate.
