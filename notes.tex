...
This result might have {\bf measurement bias}\footnote{Todd Mytkowicz et al. {\em Producing Wrong Data Without Doing Anything Obviously Wrong!}. \url{www-plan.cs.colorado.edu/diwan/asplos09.pdf}}, nonetheless it indicates a strong speedup because of logical improvements.
\\
This example demonstrates that computationally difficult problems can be sped up by applying logic and proper heuristics.
