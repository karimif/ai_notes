...
A {\bf support Vector machine} (SVM) is a large margin a linear classifier. In order to get a large margin, the motivation for the cost function definition is:
\begin{itemize}
...
SVMs can efficiently perform a non-linear classification using the {\bf kernel trick} which implicitly maps inputs into high-dimensional feature spaces.
