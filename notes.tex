...
The cost function for $K$ output units and $L$ layers is a {\bf a cross-entropy function} and is defined as follows (with $h_\Theta(x) \in \mathbb{R}^K$ and $(h_\Theta(x))_i = i^{th}$ output):
