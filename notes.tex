...
{\bf Decision tree} learning algorithms are simple and successful forms of machine learning. A decision tree maps an input vector to a single output value, the "decision". Input and output values can be discrete or continuous. This section covers decision trees for classification which map a discrete input vector to a discrete output value, the class. \\
