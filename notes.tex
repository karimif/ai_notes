...
{\bf Anomaly detection} allows to find data that does not conform to an expected pattern. The cluster-based approach of Algorithm~\ref{data:anomalydetection} relies on Gaussian distribution of the data:
...
\State \Comment{Assumes independence between components}
