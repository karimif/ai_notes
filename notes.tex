...
Y = Y - \mu
\end{align*}
Mean normalization only takes rated items into account with $m^{(i)}$ the number users who rather item $i$. Feature scaling is not necessary as all ratings are already on the same scale.
