...
Figure~\ref{ref:neuralnetwork} contains a {\bf feed-forward neural network}. They propagate input values through to the output layer. Neurons use the {\bf Sigmoid activation function} in contrast to the sign function used in perceptrons.
