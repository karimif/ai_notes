...
\\
The product of two Gaussians $\mu_1, \sigma_1, \mu_2, \sigma_2$ is proportional to a Gaussian:
\begin{align*}
...
{\bf Kalman filters} allow to estimate the state of a dynamic system. In comparison to Markov localization, they are {\bf continuous} and {\bf uni-modal}. Kalman filters use a {\bf Gaussian distribution} to represent the belief state.
