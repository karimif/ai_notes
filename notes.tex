...
First, the training examples can be chosen randomly from the training set. Then, the training is continued until the algorithm converges.
Second, the learning rate can be changed during the learning to converge faster.
