...
Problem solution can be either atomic (e.g. an action) or compound (e.g. a sequence of actions). Cases can be either monolithic (e.g., observation ? action) or compound (e.g., a set of observations $\implies$ a sequence of actions).
