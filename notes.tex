...
The {\bf shortest path} algorithms finds the shortest path from the {\bf start state} to a {\bf goal state}. Each state might have a number of {\bf successors}.

\begin{algorithm}
\caption{Sample Markov localization}
\label{ref:shortestpathpython}
\begin{python}
